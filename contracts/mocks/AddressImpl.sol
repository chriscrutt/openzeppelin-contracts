...
contract AddressImpl {
    ...
    function sendValue(address payable receiver, uint amount) external {
    ...
    function functionCallWithValue(address target, bytes calldata data, uint value) external payable {
