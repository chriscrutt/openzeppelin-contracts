...
contract ERC2718 is Context {
    ...
    function balanceOf(address account) public view returns (uint256) {
        Voter storage b = _voters[account];
        return b.shares;
    }
    ...
    function _invest(address _owner, uint256 _shares) private {
        ...
        Voter storage b = _voters[_owner];
    ...
    function _transferShares(
        ...
        Voter storage _s = _voters[_sender];
        _s.shares = _s.shares.sub(_amount, "transfer amount exceeds balance");

        Voter storage _r = _voters[_recipient];
    ...
    function _vote(
        ...
        Voter storage v = _voters[_contributor];
