...
library SafeMath {
        ...
        returns (bool, uint256)
    {
        ...
        // being zero, but the benefit is lost if 'b' is also tested.
     ...
     * reverting on division by zero. The result is rounded towards zero
     *
     * Counterpart to Solidity's `/` operator. Note: this function uses
     * a `revert` opcode (which leaves remaining gas untouched) while
    ...
    /**
     * @dev Returns the remainder of dividing two unsigned integers.
     * (unsigned integer modulo), reverting when dividing by zero.
     *
    ...
    /**
     * @dev Returns the integer division of two unsigned integers,
     * reverting with custom message on division by zero. The result is
     * rounded towards zero.
     *
     * CAUTION: This function is deprecated because it requires
     * allocating memory for the error message unnecessarily. For custom
     * revert reasons use {tryDiv}.
     *
     * Counterpart to Solidity's `/` operator. Note: this function uses
     * a `revert` opcode (which leaves remaining gas untouched) while
     * Solidity uses an invalid opcode to revert (consuming all
    ...
    /**
     * @dev Returns the remainder of dividing two unsigned integers.
     * (unsigned integer modulo), reverting with custom message when
     * dividing by zero.
     *
     * CAUTION: This function is deprecated because it requires
     * allocating memory for the error message unnecessarily. For custom
     * revert reasons use {tryMod}.
     *
     * Counterpart to Solidity's `%` operator. This function uses a
     * `revert` opcode (which leaves remaining gas untouched) while
     * Solidity uses an invalid opcode to revert (consuming all
