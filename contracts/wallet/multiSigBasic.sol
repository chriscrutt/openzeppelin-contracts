...
contract MultiSigBasic is Context {
    ...
    function initiateTransfer(uint256 amount, address sendTo) public {
        ...
        _initiateTransfer(amount, sendTo, block.timestamp.add(10 minutes));
    }
    ...
    function completeTransfer(uint256 amount, address sendTo) public {
        ...
        _completeTransfer(amount, sendTo);
    }
    ...
    function _completeTransfer(uint256 _amount, address _sendTo) private {
